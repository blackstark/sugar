...
require_once('modules/real_Reality/Model.php');
class real_RealityViewMy extends Model
{
    ...
    function display()
    {
        ...
        if (isset($_REQUEST['rooms'])) {
            ...
            $result = $db->query("SELECT * FROM real_reality WHERE rooms = $rooms"); //результат SQL запроса.
            ...
            */
             ...
             *
            $query = "select * from users where id in ( select assigned_user_id from real_reality where name = 'объект1' )";
            $focus = new real_Reality();
            $focus->retrieve_by_string_fields(array('name' => 'объект1' ));
            ...
            */
             ...
             *
            $query = "update real_reality set repair = 'ремонт изменен' where id = '788f10e5-4781-9f5a-dea0-5475985027b5'";
            $focus = new real_Reality();
